...
# Sicherstellen, dass Date korrekt ist
...
def sequential_feedback_fe(df, step1_dv, step1_iv, step2_dv, step2_iv,
    ...
    ci_ind = ((np.exp(b1*b2 - z*indirect_se)-1)*100,
...
# 6. HYPOTHESEN
# =========================
controls = ["Protests_log_lag2","participants_log_lag2",
            "Posts_log_lag2","Active_Accounts_log_lag2"]

h3a = [
    {"label":"H3a1","step1_dv":"Posts_log_lag1","step1_iv":"Protests_log_lag2",
     "step2_dv":"Protests_log","step2_iv":"Posts_log_lag1"},
    {"label":"H3a2","step1_dv":"Active_Accounts_log_lag1","step1_iv":"Protests_log_lag2",
     "step2_dv":"Protests_log","step2_iv":"Active_Accounts_log_lag1"},
]

h3b = [
    {"label":"H3b1","step1_dv":"Protests_log_lag1","step1_iv":"Posts_log_lag2",
