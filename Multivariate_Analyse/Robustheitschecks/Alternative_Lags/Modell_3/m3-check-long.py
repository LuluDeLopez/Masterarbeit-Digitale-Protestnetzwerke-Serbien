...
for var in lag_vars:
    ...
    df[f"{var}_lag6"] = df.groupby("Location")[var].shift(6)  # für Step2
...
h3_3lags_hypotheses = [
    {"label":"H3a1: Protests → Posts → Protests", "step1_dv":"Posts_log_lag6", "step1_iv":"Protests_log_lag3",
     "step2_dv":"Protests_log", "step2_iv":"Posts_log_lag6"},
    {"label":"H3a2: Protests → ActiveAccounts → Protests", "step1_dv":"Active_Accounts_log_lag6", "step1_iv":"Protests_log_lag3",
     "step2_dv":"Protests_log", "step2_iv":"Active_Accounts_log_lag6"},
    {"label":"H3a3: Participants → Posts → Participants", "step1_dv":"Posts_log_lag6", "step1_iv":"participants_log_lag3",
     "step2_dv":"participants_log", "step2_iv":"Posts_log_lag6"},
]
...
def run_3lags_all_levels():
    ...
    for level, df_level in agg_dfs.items():
        ...
        for hyp in h3_3lags_hypotheses:
